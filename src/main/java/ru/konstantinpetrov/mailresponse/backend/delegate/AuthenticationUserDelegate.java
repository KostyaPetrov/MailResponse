...
public class AuthenticationUserDelegate implements JavaDelegate{
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception{
        ...
        if(user.getRole() == Roles.USER){
            delegateExecution.setVariable("userRoleApprove", true);
        }else{
            delegateExecution.setVariable("userRoleApprove", false);
